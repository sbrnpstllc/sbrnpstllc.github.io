    ...
    <div id="tarifs" class="container">
        <div class="row">
            ...
            <div class="col-md-8">
                ...
                <h4><i class="fas fa-camera-retro"></i> Séance portrait (1h environ, à votre domicile ou lieu de votre choix)</h4>
                <div class="row">
                  <div class="col-md-6">
                    <p>Couple, famille, enfant (plus de 3 mois)</p>
                  </div>
                  <div class="col-md-6">
                    <p class="text-danger"><strong>70€</strong></p>
                  </div>
                </div>
                <h4><i class="fas fa-camera-retro"></i> Séance naissance (1h environ, à votre domicile ou lieu de votre choix)</h4>
                <div class="row">
                  <div class="col-md-6">
                    <p>Séance grossesse seule</p>
                  </div>
                  <div class="col-md-6">
                    <p class="text-danger"><strong>80€</strong></p>
                  </div>
                </div>
                <div class="row">
                  <div class="col-md-6">
                    <p>Séance nouveau né seule</p>
                  </div>
                  <div class="col-md-6">
                    <p class="text-danger"><strong>80€</strong></p>
                  </div>
                ...
                <div class="row">
                  ...
                  <div class="col-md-6">
                    <p class="text-danger"><strong>160€</strong></p>
                  </div>
                </div>
                <p>
                  <em>
                ...
                <h4><i class="fas fa-camera-retro"></i> Forfait de base</h4>
                <p>
                  Cérémonie(s) + photos de groupe et de couple le jour du mariage + vin d'honneur + 30 tirages 11x18 cm
                </p>
                <div class="row">
                  <div class="col-md-6">
                    <p>Mairie seule</p>
                  ...
                  <div class="col-md-6">
                    <p class="text-danger"><strong>550€</strong></p>
                  </div>
                </div>
                <div class="row">
                  <div class="col-md-6">
                    <p>Mairie + cérémonie religieuse ou laïque</p>
                  </div>
                  <div class="col-md-6">
                    <p class="text-danger"><strong>600€</strong></p>
                  </div>
                </div>
                <h4><i class="fas fa-camera-retro"></i> Options</h4>
                <div class="row">
                  <div class="col-md-6">
                    <p>Préparation de la mariée</p>
                  </div>
                  <div class="col-md-6">
                ...
                <div class="row">
                  <div class="col-md-6">
                    <p>Soirée avec repas + ouverture de bal filmée</p>
                  </div>
                  <div class="col-md-6">
                    <p class="text-danger"><strong>250€</strong></p>
                  </div>
                </div>
                <div class="row">
                  <div class="col-md-6">
                  ...
                  <div class="col-md-6">
                    <p class="text-danger"><strong>100€</strong></p>
                  </div>
                </div>
                <div class="row">
                  <div class="col-md-6">
                    <p>Décalage de la séance de couple avant ou après le mariage</p>
                  </div>
                  <div class="col-md-6">
                    <p class="text-danger"><strong>50€</strong></p>
                  </div>
                </div>
                <p>
                  <em>Ces offres incluent : galerie web avec accès privatif permettant le téléchargement des photos / le tri et le traitement des photos / les photos de groupes / le déplacement < 50km (0.50€/km supplémentaire) / photos sur clé USB</em>
                  <br />
                  <em>Nb : ces offres peuvent être modifiées sur demande en fonction de vos attentes</em>
                </p>
            </div>
            <div class="col-md-2"></div>
        </div>
